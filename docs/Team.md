# OpenTeamManager Takımı ve Rolleri (Örnek)
<details open>
...
### ➡️ [Güncel Takım Listesi İçin Tıkla](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/OpenTeamManager)

---
## 📊 Takım İstatistikleri

- **Proje Adı:** Ekip yönetimini basitleştir, verimliliği artır!
- **Takım Adı:** OpenTeamManager
...
### ➡️ [Click Here for the Current Team List](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/OpenTeamManager)

---

## 📊 Team Statistics

- **Project Name:** Ekip yönetimini basitleştir, verimliliği artır!
- **Team Name:** OpenTeamManager
